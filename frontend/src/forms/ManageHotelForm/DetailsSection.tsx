...
const DetailsSection = () => {
  ...
  return (
    <div className="flex flex-col gap-4">
      ...
      <label className="text-gray-700 text-sm font-bold max-w-[50%] ">
        Star Rating
        <select aria-label="Star rating selection" className="border rounded w-full p-2 text-gray-700 font-normal" {...register("starRating", { required: "This field is required" })}>
